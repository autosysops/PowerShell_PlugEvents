...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\plugEvents\functions", "$global:testroot\..\plugEvents\internal\functions"),

	[string]
	$ModuleName = "plugEvents",
...
$CommandPath = @(
    "$global:testroot\..\plugEvents\functions"
    "$global:testroot\..\plugEvents\internal\functions"
)
